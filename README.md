...
# Backend meets Frontend: The basics for multi-browser UI testing
Now, as a web developer, you do not only have to deal with a target system: in one browser, the UI test is missing, not in the next one. It is important to lay the foundations for cross-browser tests. This requires the WebDriver Binary to be managed. This part of "Backend meets Frontend" shows how.
...
* german article [http://bit.ly/jaxenter-007](http://bit.ly/jaxenter-007)
